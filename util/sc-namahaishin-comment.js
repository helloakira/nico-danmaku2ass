...
function onMessage_system(evt)
{
  ...
  if(is_room>0){
		...
		playTimeArray = document.getElementsByClassName("___max-value___19FIW")[0].textContent.split(":");
		...
		liveStartTime = new Date(document.getElementsByClassName("___onair-time___2w3b3")[0].getAttribute("datetime")).getTime()/1000;
